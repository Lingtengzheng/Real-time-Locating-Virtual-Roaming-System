...
extern "C" _declspec(dllexport) int begin1()
{
	int i, j, k;
...
extern "C" _declspec(dllexport) int getX1(int i)
{
	return x3[i];
}

extern "C" _declspec(dllexport) int getY1(int i)
{
	return y3[i];
}

extern "C"_declspec(dllexport) int getSize1(int i)
{
	return size3[i];
